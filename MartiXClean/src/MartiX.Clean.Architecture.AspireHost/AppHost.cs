...
var web = builder.AddProject<Projects.MartiX_Clean_Architecture_Web>("web")
...
builder.AddProject<Projects.MartiX_Clean_Architecture_Blazor>("blazor")
      .WithEnvironment("ASPNETCORE_ENVIRONMENT", builder.Environment.EnvironmentName)
      .WithReference(web)
      .WaitFor(web)
      .WithUrl("https://localhost:57380"); // Match launchSettings
